...
class Controller
{
    ...
    public function loadModel()
    {
        ...
        require APP . 'model/listing_model.php';
        require APP . 'model/media_model.php';
        require APP . 'model/thumbnail_model.php';
        require APP . 'model/messages_model.php';
        // create new "model" (and pass the database connection)
        //$this->model = new Model($this->db);
        $this->userModel = new UserModel($this->db);
        $this->listingModel = new ListingModel($this->db);
        $this->mediaModel = new MediaModel($this->db);
        $this->thumbnailModel = new ThumbnailModel($this->db);
