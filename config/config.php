...
define('UPLOAD_DIR', SITE_ROOT . UPLOAD_PATH);
define('THUMBNAIL_DIR', UPLOAD_DIR . 'thumbnails/');

// For maps
define('API_KEY', 'AIzaSyD6ld1Feu8_pIkIwA_j51qwIcCZtxfVleM');
define('MAPS_QUERY_URL', 'https://maps.googleapis.com/maps/api/geocode/json');
define('MAPS_DISTANCE_URL', 'https://maps.googleapis.com/maps/api/distancematrix/json');
define('SFSU_LAT', 37.7212945);
define('SFSU_LONG', -122.4785849);
...
define('DB_PORT', '3306');
define('DB_NAME', 'f16g06');
define('DB_USER', 'f16g06');
